with table_name_override(table_name, excel_sheet) as(values 
    ...
    sead_table_types(table_name, table_type) as (values
        ...
        ('tbl_seasons', 'lookup'),
        ('tbl_site_images', 'metadata'),
        ('tbl_site_locations', 'metadata'),
        ('tbl_site_natgridrefs', 'metadata'),
        ('tbl_site_other_records', 'metadata'),
        ('tbl_site_preservation_status', 'metadata'),
        ('tbl_site_references', 'metadata'),
        ('tbl_sites', 'metadata'),
